							...
							<div class="row">
								...
								<div>
									<div class="form-group">
										...
										<span id="biografia" class="form-control"><?php echo $biografia ?></span>
								...
								<div>
									<form class="form-group bio" id="form" method="post" action=<?php base_url("Vista_Perfil");?>>
										<label>Bio</label>
										<input type="text" class="campo form-control" id="biografia" name="biografia" placeholder="Escribe aquí una pequeña biografía" rows="4">
