...
<head>
    ...
    <link rel="stylesheet" href="<?php base_url();?>../style-categories.css">
    ...
    <nav class="navbar navbar-dark bg-dark sticky-top">
      ...
      <div class="container-fluid">
        ...
        <a class="navbar-brand title-nav" href="inicio">
          <img class="logo-nav" src="img/logo-umc.png" alt="">
          UMC Marketplace
        </a>
          ...
          <div class="container-fluid">
            <form class="d-flex" role="search">
              ...
              <button class="btn btn-outline-light btn-busqueda" type="submit">
                <img class="buscar-logo" src="img/busqueda.svg" alt="">
              </button>
            </form>
          </div>
        </nav>

        <!--MBoton del menu desplegable a la derecha-->
